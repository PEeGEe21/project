...
if(isset($_POST['submit']))
  {
    ...
    // header("location: register.php?confirm");  
    ...
    header("location: confirm.php?confirm");  
    
}

// else {
//     echo "<script>alert('lollll');</script>";
//     // exit();
//     } 
                ...
                <!-- <form > -->
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-8">
                            ...
                            <!-- <button type="submit"  id="signin-btn">Review</button> -->
...
// }
        ...
        <script>
            ...
            function confirmsub(){
                ...
                var inputMobno = document.getElementById("mobno").value
                var inputEmail = document.getElementById("email").value
                var inputContact = document.getElementById("contact").value
                var inputPayment = document.getElementById("payment").value
                var inputDonation = document.getElementById("donation").value
                var inputCurrency = document.getElementById("currency").value
                var inputComment = document.getElementById("comment").value

                
                var value = [
                    inputLname, inputFname, inputAddress, inputCity, 
                    inputState, inputCountry, inputPostcode, 
                    inputMobno, inputEmail, inputContact, 
                    inputPayment, inputDonation, inputCurrency, inputComment
                ]
